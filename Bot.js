...
function createBot() {
    const bot = mineflayer.createBot({
        host: 'Oi22i.aternos.me', // <--- REEMPLAZA ESTO POR LA IP DE TU SERVER
        port: 14210,                // Puerto predeterminado de Minecraft
        username: 'kai',    // Nombre gen茅rico del bot/NPC dentro del juego
